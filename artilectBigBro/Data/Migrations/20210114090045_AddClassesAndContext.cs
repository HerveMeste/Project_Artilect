...
{
    public partial class AddClassesAndContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BadgesBadgeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BadgeUser", x => new { x.BadgesBadgeId, x.UsersId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BadgeUser_Badges_BadgesBadgeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InterestsInterestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
